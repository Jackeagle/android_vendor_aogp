...
# Head
echo -n '<!DOCTYPE html><head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>AOGP - Changelog</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"><link rel="stylesheet" type="text/css" href="/css/bootstrap.min.css"></head>' >> ${outputfile}
# Body
echo -n '<body style="background:#f9f9f9;"><div class="container"><h1>AOGP&nbsp;<small>'${changes_since}'</small></h1><h4 style="padding-top:10px;padding-bottom:20px;">'${update_name}'&nbsp;<small>'${update_md5}'</small></h4><ul class="list-group">' >> ${outputfile}
...
do
    ...
    if [ -z "${log}" ]; then
        ...
        do
            ...
            echo -n '<li class="'${project}'-content list-group-item hidden" style="background-color:#f7f7f9;margin-left:10px;"><a href="https://github.com/AOGP/'${project}'/commit/'${change_id}'" target="_blank"><b>'${change_id}'</b></a>&nbsp;-&nbsp;<em>'${change_title}'</em></li>' >> ${tmpfile}content
